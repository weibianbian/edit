...
namespace BT.Editor
{
    public class BaseEdgeDragHelper : EdgeDragHelper
    {
        ...
        protected Dictionary<BehaviorGraphNodeView, List<NodePortView>> compatiblePorts = new Dictionary<BehaviorGraphNodeView, List<NodePortView>>();
        ...
        Rect GetPortBounds(BehaviorGraphNodeView nodeView, int index, List<NodePortView> portList)
        {
