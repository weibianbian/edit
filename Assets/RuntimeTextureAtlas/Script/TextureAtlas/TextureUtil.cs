...
namespace RuntimeTextureAtlas
{
	...
	public static class TextureUtil
	{
		...
		public static void DrawTexture(Texture source, RenderTexture target, RectInt position)
		{
			...
			{
				//var shader = Shader.Find("Hidden/RuntimeTextureAtlas/DrawTexture");
				var shader = Shader.Find("Assets/Test/BlitCopy.shader");
            ...
            uploadMateral.SetVector(ShaderScaleOffset, new Vector4(position.x, position.y, position.width, position.height));
